...
public class Lambda01 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(findSumOfIntegersBetweenTwoGivenIntegers(2, 8));
        System.out.println();
        System.out.println(sumOfDigitsFromFirstToLast1(45, 47));
        System.out.println();
        System.out.println(sumOfDigitsFromFirstToLast1(45, 47));
        System.out.println();
    ...
    public static List<Integer> getSquaresOfLengthsInListDistinctly1(List<String> names){
        return names.
                ...
                map(String::length). // map(t->t.length()) can be used as well
                                        // t->t.length() is lambda expression
                                                //String::length - is called "Method Reference"
                distinct().map(Utils::getSquare).
    ...
    */
    ...
    public static void printIntegers2(int start,int end){
        IntStream.rangeClosed(start,end).forEach(Utils::printInTheSameLine); // t-> System.out.println(t+" ") can be used as well
    }
    ...
    public static int findSumOfIntegersBetweenTwoGivenIntegers (int start, int end){
        if(start>end){
            int temp=start;
            start = end;
            end=temp;
    ...
    //           4+5+4+6+4+7=30
    //1.Way:
    public static int sumOfDigitsFromFirstToLast1(int start, int end){
        return IntStream.rangeClosed(start,end).
                map(Utils::fintSumOfDigits).
                reduce(Math::addExact).getAsInt();
    }
    //2.Way:
    public static int sumOfDigitsFromFirstToLast2(int start, int end){
        return IntStream.rangeClosed(start,end).
                map(Utils::fintSumOfDigits).
                sum();
    }
